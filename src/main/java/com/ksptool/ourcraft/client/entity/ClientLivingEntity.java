...
import com.ksptool.ourcraft.client.world.ClientCollisionManager;
 ...
 */
@Getter
public abstract class ClientLivingEntity extends ClientEntity {
    ...
    //碰撞管理器
    protected ClientCollisionManager collisionManager;
