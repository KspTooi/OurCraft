package com.ksptool.ourcraft.clientjme.rendering;
 ...
 */
@Slf4j
public class JmeTextureManager {
    ...
    // 纹理图集管理器实例
    private static JmeTextureManager instance;
    ...
    public static JmeTextureManager getInstance() {
        if (instance == null) {
            instance = new JmeTextureManager();
        }
        return instance;
    }
