 ...
 */
public class JmeMeshGenerationResult {
    ...
    public JmeMeshGenerationResult(int chunkX, int chunkZ, float[] vertices, float[] texCoords, float[] tints, int[] indices) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
    ...
    public JmeMeshGenerationResult(int chunkX, int chunkZ, float[] vertices, float[] texCoords, float[] tints, float[] animationData, int[] indices,
