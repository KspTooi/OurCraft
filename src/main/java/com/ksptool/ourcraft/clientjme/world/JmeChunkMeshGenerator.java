...
public class JmeChunkMeshGenerator {
    ...
    public JmeChunkMeshGenerator(com.ksptool.ourcraft.client.world.ClientWorld clientWorld) {
        this.clientWorld = clientWorld;
        int numThreads = Math.max(1, Runtime.getRuntime().availableProcessors() - 1);
        this.executor = Executors.newFixedThreadPool(numThreads);
    }

    public void submitMeshTask(com.ksptool.ourcraft.client.world.ClientChunk chunk) {
    ...
    public MeshGenerationResult calculateMeshData(com.ksptool.ourcraft.client.world.ClientChunk chunk, com.ksptool.ourcraft.client.world.ClientWorld clientWorld) {
        ...
        for (int x = 0; x < com.ksptool.ourcraft.client.world.ClientChunk.CHUNK_SIZE; x++) {
            for (int y = 0; y < com.ksptool.ourcraft.client.world.ClientChunk.CHUNK_HEIGHT; y++) {
                for (int z = 0; z < com.ksptool.ourcraft.client.world.ClientChunk.CHUNK_SIZE; z++) {
                    ...
                    int worldX = chunkX * com.ksptool.ourcraft.client.world.ClientChunk.CHUNK_SIZE + x;
