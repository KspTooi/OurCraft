...
public record PsNVo(
    ...
    public static PsNVo of(String worldName, int aps, long totalActions, LocalDateTime startDateTime) {
        return new PsNVo(worldName, aps, totalActions, startDateTime);
    }
